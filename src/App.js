  ...
  return (
     <div>
      ...
      <div className='flex relative dark:bg-main-dark-bg'>
        ...
        {activeMenu ? (<div 
        className='w-72 fixed sidebar dark:bg-seondary-dark-bg bg-white' >sidebar</div>):(<div 
        className='w-0 dark:bg-secondary-dark-bg'>sidebar W-0</div>)}

        <div class={`dark:bg-main-bg min-h-screen w-full ${activeMenu ? 'md:ml-72' : 'flex-2'}`}>
